const handleJustificativa = (personId, texto) => {
  ...
  const handleExport = () => {
    ...
    // Adiciona faltas e justificativas
...
import { Calendar, Download, RotateCcw, Users } from 'lucide-react';
      ...
      <div className="max-w-full mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-3xl font-bold text-slate-800">Atribuição Diária de Setores</h1>
          </div>
        ...
        <div className="bg-red-50 rounded-lg shadow-md border-4 border-dashed border-red-300 p-4">
          <h2 className="font-bold text-red-700 mb-4 text-lg">❌ FALTA ({assignments['falta']?.length || 0})</h2>
          <div
            onDragOver={handleDragOver}
