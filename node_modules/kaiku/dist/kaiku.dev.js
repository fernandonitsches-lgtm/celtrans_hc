...
Component[_a] = true;
const EMPTY_OBJECT = true ? Object.freeze({}) : {};
...
const assert = true ? __assert : void 0;
...
const childToDescriptor = (child) => {
  if (child === null || child === void 0 || typeof child === "boolean") {
    return { tag_: "TextNode", value_: "" };
  }
  if (typeof child === "string" || typeof child === "number") {
    return { tag_: "TextNode", value_: child };
  }
...
const reuseNodeInstance = (instance, descriptor) => {
  const isSameFunctionComponent = instance.tag_ === "FunctionComponent" && descriptor.tag_ === "FunctionComponent" && instance.func === descriptor.func;
  const isSameClassComponent = instance.tag_ === "ClassComponent" && descriptor.tag_ === "ClassComponent" && instance.instance instanceof descriptor.class_;
  if (isSameFunctionComponent || isSameClassComponent) {
    assert?.(instance.tag_ === "FunctionComponent" || instance.tag_ === "ClassComponent");
    assert?.(descriptor.tag_ === "FunctionComponent" || descriptor.tag_ === "ClassComponent");
  ...
  if (instance.tag_ === "HtmlElement" && descriptor.tag_ === "HtmlElement" && instance.tagName_ === descriptor.tagName_) {
    updateHtmlElementInstance(instance, descriptor.props_, descriptor.children_);
    return true;
  }
  if (instance.tag_ === "Fragment" && descriptor.tag_ === "Fragment") {
    updateFragmentInstance(instance, descriptor.children_);
    return true;
  }
  if (instance.tag_ === "TextNode" && descriptor.tag_ === "TextNode") {
...
const updateComponentInstance = (instance, props = instance.props_) => {
  let childDescriptor;
  if (instance.tag_ === "FunctionComponent") {
...
const Fragment = true ? () => assert(false, "Fragment should not be called explicitly") : () => {
};
...
const NODE_CREATORS = {
  ["ClassComponent"]: createClassComponentInstance,
  ["FunctionComponent"]: createFunctionComponentInstance,
  ["HtmlElement"]: createHtmlElementInstance,
  ["Fragment"]: createFragmentInstance,
  ["TextNode"]: createTextInstance
};
...
const mountNodeInstance = (instance, parentElement, nextSibling) => {
  ...
  switch (instance.tag_) {
    ...
    case "ClassComponent": {
      ...
      if (instance.tag_ === "ClassComponent" && !instance.hasMounted) {
    ...
    case "HtmlElement":
    case "TextNode": {
      if (instance.tag_ === "HtmlElement" && instance.children_) {
...
const unmountNodeInstance = (instance) => {
  switch (instance.tag_) {
    ...
    case "ClassComponent": {
      ...
      if (instance.tag_ === "ClassComponent") {
